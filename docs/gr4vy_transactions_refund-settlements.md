## gr4vy transactions refund-settlements

Manage transactions refund-settlements

### Options

```
  -h, --help   help for refund-settlements
```
...
* [gr4vy transactions refund-settlements get](gr4vy_transactions_refund-settlements_get.md)	 - Get transaction refund settlement
* [gr4vy transactions refund-settlements list](gr4vy_transactions_refund-settlements_list.md)	 - List transaction refund settlements
